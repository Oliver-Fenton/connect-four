...
object Model {
    ...
    /**
     * Player #1's number of wins
     */
    var p1Score: Int = 0

    /**
     * Player #2's number of wins
     */
    var p2Score: Int = 0
    ...
    /**
     * Enhancement:
     * Restarts the game. Listen to [onNextPlayer] to receive notification about changing player and turns.
     *
     */
    fun restartGame() {
        grid.clear()
